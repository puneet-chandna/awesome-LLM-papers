...
_From adversarial attacks to alignment techniques, these papers explore the critical challenges of building safe and robust AI systems._
...
**Authors:** Anthropic  
**Contribution:** `🔓 Long-Context Attacks`

> Demonstrated that **long-context windows enable new attack vectors**. By showing models 100+ "fake" harmful Q&A pairs in the context window (Many-Shot Jailbreak), attackers can override safety training using the very "In-Context Learning" ability we prize. This exploits the model's capacity to learn from examples, turning a capability into a vulnerability. Critical research showing that longer contexts require new safety approaches.

### 📄 🆕 [Safety Alignment Should Be Made More Than Just A Few Tokens Deep](https://openreview.net/forum?id=ukRJJ9xrL3)

**Authors:** ICLR 2025  
**Contribution:** `⚠️ Shallow Alignment`

> Reveals a critical weakness: **most "safety" training only affects the first few tokens** of a response. If an attacker can force the model to start with "Sure, here is how...", the safety guardrails often collapse completely (the "Shallow Alignment" hypothesis). This research explains why many jailbreaks work and highlights fundamental challenges in current alignment techniques.
